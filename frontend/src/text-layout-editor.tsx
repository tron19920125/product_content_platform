    ...
    <div className="text-layout-workspace">
      ...
      <aside className={`text-property-panel ${inspectorView === "fonts" ? "font-library-view" : ""}`}>
        {selectedFeature && selectedGroup ? <>
          <header><strong>卖点项属性</strong><span className="feature-source-tag">{selectedFeature.icon_source === "generated" ? "AI 图标" : selectedFeature.icon_source === "user_upload" ? "上传图标" : "平台图标"}</span></header>
